...
public class DeleteRecipientByNumber_Integration_Test
{
    ...
    [Fact]
    public async Task DeleteRecipientByNumberAsync_Test()
    {
        var apiKey = new InMobileApiKey("UnitTestKey123");
        var expectedRequest = new UnitTestRequestInfo(apiKey: apiKey, methodAndPath: "DELETE /v4/lists/some_list_id/recipients/bynumber?countryCode=47&phoneNumber=11223344", jsonOrNull: null);
        var responseToSendback = new UnitTestResponseInfo(jsonOrNull: null, statusCodeString: "204 NoContent");
        ...
        {
            var client = new InMobileApiClient(apiKey, baseUrl: $"http://{server.EndPoint.Address}:{server.EndPoint.Port}");
            await client.Lists.DeleteRecipientByNumberAsync(listId: new RecipientListId("some_list_id"), numberInfo: new NumberInfo(countryCode: "47", phoneNumber: "11223344"));
    ...
    [Fact]
    public async Task DeleteRecipientByNumberAsync_ApiError_NotFound_Test()
    {
        var apiKey = new InMobileApiKey("UnitTestKey123");
        var expectedRequest = new UnitTestRequestInfo(apiKey: apiKey, methodAndPath: "DELETE /v4/lists/some_list_id/recipients/bynumber?countryCode=47&phoneNumber=11223344", jsonOrNull: null);
        var responseToSendback = new UnitTestResponseInfo(jsonOrNull: @"{
        ...
        {
            var client = new InMobileApiClient(apiKey, baseUrl: $"http://{server.EndPoint.Address}:{server.EndPoint.Port}");
            var ex = await Assert.ThrowsAsync<InMobileApiException>(() => client.Lists.DeleteRecipientByNumberAsync(listId: new RecipientListId("some_list_id"), numberInfo: new NumberInfo(countryCode: "47", phoneNumber: "11223344")));
    ...
    [Fact]
    public async Task DeleteRecipientByNumberAsync_ApiError_InternalServerError_Test()
    {
        var apiKey = new InMobileApiKey("UnitTestKey123");
        var expectedRequest = new UnitTestRequestInfo(apiKey: apiKey, methodAndPath: "DELETE /v4/lists/some_list_id/recipients/bynumber?countryCode=47&phoneNumber=11223344", jsonOrNull: null);
        var responseToSendback = new UnitTestResponseInfo(jsonOrNull: @"{
