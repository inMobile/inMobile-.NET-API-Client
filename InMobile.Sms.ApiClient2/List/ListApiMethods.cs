...
namespace InMobile.Sms.ApiClient
{
    ...
    internal class ListApiMethods : IListApiMethods
    {
        ...
        {
            GuardHelper.EnsureNotNullOrThrow(parameterName: nameof(RecipientCreateInfo), value: recipient);
        ...
        private Recipient UpdateRecipientInternal(RecipientListId listId, RecipientId recipientId, object updateObject)
        {
            GuardHelper.EnsureNotNullOrThrow(parameterName: nameof(listId), value: listId);
            GuardHelper.EnsureNotNullOrThrow(parameterName: nameof(recipientId), value: recipientId);
            GuardHelper.EnsureNotNullOrThrow(parameterName: nameof(updateObject), value: updateObject);
