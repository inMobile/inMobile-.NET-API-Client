...
namespace InMobile.Sms.ApiClient
{
    public class OutgoingSmsMessageCreateInfo
    {
        ...
        /// <summary>
        /// The actual value that will be sent to the api. Exposed for easier debugging possibilities on the client side.
        /// </summary>
        [JsonProperty("ValidityPeriodInSeconds")]
        public int? RawValidityPeriodInSeconds
        {
            get
            {
                if (ValidityPeriod != null)
                    return (int)ValidityPeriod.Value.TotalSeconds;
                return null;
            }
        }

        public OutgoingSmsMessageCreateInfo(string to, string text, string from, string? messageId = null, bool respectBlacklist = true, bool flash = false, MessageEncoding encoding = MessageEncoding.gms7, TimeSpan? validityPeriod = null)
        {
