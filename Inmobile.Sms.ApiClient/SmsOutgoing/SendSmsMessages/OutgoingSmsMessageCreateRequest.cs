...
namespace InMobile.Sms.ApiClient
{
    public class OutgoingSmsMessageCreateRequest
    {
        ...
        public OutgoingSmsMessageCreateRequest(string to, string text, string from, string? messageId = null, bool respectBlacklist = true, bool flash = false, MessageEncoding encoding = MessageEncoding.Gsm7, TimeSpan? validityPeriod = null, string statusCallbackUrl = null, DateTime? sendTime = null)
        {
